<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="pop_bg" id="shopadd_pop" style="display:none">
	<div class="shop_modify_box">
		<div class="title no_drag">
			...
			<div class="right">
			<span onClick="document.getElementById('shopadd_pop').style.display='none';">x</span>
			</div>
		</div>
		<div class="content">
			<div class="title">
